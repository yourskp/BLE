...
#define SIM_RR_INTERVAL_MIN             (500u)      /* Minimum simulated RR-interval */
#define SIM_RR_INTERVAL_MAX             (1000u)     /* Maximum simulated RR-interval */
#define SIM_RR_INTERVAL_INCREMENT       (10u)       /* Value by which the RR-interval is incremented */
